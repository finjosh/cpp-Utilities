...
SOURCE_FILES_NO_GRAPHICS:=$(call FIX_PATH,${SOURCE_FILES_NO_GRAPHICS})
...
PROJECT_FILES:=${PROJECT_DIRECTORY}${PROJECT_OUT_DIRECTORY}${PATH_SEPARATOR}lib${PROJECT_NAME}${LIB_EXTENSION} \
				${PROJECT_DIRECTORY}${PROJECT_OUT_DIRECTORY}${PATH_SEPARATOR}lib${PROJECT_NAME}-no-graphics${LIB_EXTENSION}
else
...
build: ${PROJECT_DIRECTORY}${PROJECT_OUT_DIRECTORY}${PATH_SEPARATOR} ${BIN_DIRECTORIES} ${OBJECT_FILES}
	...
	${CREATE_LIB} $(call FIX_PATH,${PROJECT_DIRECTORY}/${PROJECT_OUT_DIRECTORY}/lib${PROJECT_NAME}-no-graphics${LIB_EXTENSION}) ${OBJECT_FILES_NO_GRAPHICS} ${PROJECT_FINAL_FLAGS}
