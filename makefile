...
LIB_OBJECT_FILES_NO_GRAPHICS:=$(patsubst ${PROJECT_DIRECTORY}%,${PROJECT_DIRECTORY}${OBJECT_OUT_DIRECTORY}%,$(patsubst %.cpp,%.o,$(call FIX_PATH,${LIB_SOURCE_FILES_NO_GRAPHICS})))
...
LIB_C_SOURCE_FILES:=$(foreach Directory,${LIB_EXPANDED_SOURCE_DIRECTORIES},$(call FIX_PATH,$(wildcard ${Directory}/*.c)))
LIB_OBJECT_FILES:=$(patsubst ${PROJECT_DIRECTORY}%,${PROJECT_DIRECTORY}${OBJECT_OUT_DIRECTORY}%,$(patsubst %.cpp,%.o,${LIB_SOURCE_FILES})) \
					$(patsubst ${PROJECT_DIRECTORY}%,${PROJECT_DIRECTORY}${OBJECT_OUT_DIRECTORY}%,$(patsubst %.c,%.o,${LIB_C_SOURCE_FILES}))
